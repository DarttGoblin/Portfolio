				...
				<div className='about-header'>
					<div className='about-header-text-content'>
						...
						<div className='about-header-contacts-container'>
							...
							<span className='about-header-contact'>Resume: <span onClick={() => {window.open('https://drive.google.com/file/d/1vNY6AJ-IxOrIOOSuSadUfWPwwJP51lgr/view?usp=drive_link', '_blank')}} className='about-header-contact-info'>https://drive.google.com/file/d/1vNY6AJ-IxOrIOOSuSadUfWPwwJP51lgr/view?usp=drive_link</span></span>
						</div>
						<Link 
							to='/Contact'
