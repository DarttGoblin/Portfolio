				...
				<div className='about-header'>
					<div className='about-header-text-content'>
						...
						<div className='about-header-contacts-container'>
							...
							<span className='about-header-contact'>Resume: <span onClick={() => {window.open('https://rb.gy/3v67w8', '_blank')}} className='about-header-contact-info'>https://rb.gy/3v67w8</span></span>
						</div>
						<Link 
							to='/Contact'
